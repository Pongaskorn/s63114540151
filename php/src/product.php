				...
				<div class="row">
					...
					$product_query = "SELECT * FROM products,categories WHERE product_cat=cat_id AND product_id BETWEEN $product_id AND $product_id+3";
                        ...
                        echo "
								...
								<a href='product.php?p='><div class='product'>
									<div class='product-img'>
										<img src='product_images/ style='max-height: 170px;' alt=''>
									...
									<div class='product-body'>
										...
										<h3 class='product-name header-cart-item-name'><a href='product.php?p='></a></h3>
										<h4 class='product-price header-cart-item-info'><del class='product-old-price'>$990.00</del></h4>
										<div class='product-rating'>
											<i class='fa fa-star'></i>
											<i class='fa fa-star'></i>
											<i class='fa fa-star'></i>
									...
									<div class='add-to-cart'>
										<button pid='' id='product' class='add-to-cart-btn block2-btn-towishlist' href='#'><i class='fa fa-shopping-cart'></i> add to cart</button>
									</div>
								</div>
                                </div>
