...
@media (max-width: 800px) {
  ...
  .col-25 {
    ...
    <div class="container-fluid">
        ...
        <?php
        include "db.php"; // ใช้ไฟล์ db.php ที่เชื่อม PostgreSQL
            ...
            <div class="col-75">
                ...
                <form id="checkout_form" action="checkout_process.php" method="POST" class="was-validated">
                    ...
                    while($i<=$total_count){
                        ...
                        $sql = "SELECT product_id FROM products WHERE product_title = $1 LIMIT 1";
                        $query = pg_query_params($con, $sql, array($item_name_));
                        $row = pg_fetch_assoc($query);
